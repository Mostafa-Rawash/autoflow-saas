          ...
          <div className="flex items-center justify-between px-4 py-3 border-t border-slate-200">
            ...
            <div className="flex items-center gap-2">
              <button 
                ...
                className={`p-2 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed ${theme === 'light' ? 'bg-slate-50 hover:bg-slate-200' : 'bg-slate-700 hover:bg-slate-600'}`}
              >
        ...
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="card max-w-2xl w-full max-h-[80vh] overflow-hidden">
            ...
            <div className="p-4 border-t border-slate-200 flex justify-end gap-2">
              ...
              <button 
                onClick={() => setSelectedLog(null)}
                className={`px-4 py-2 rounded-lg ${theme === 'light' ? 'bg-slate-50 hover:bg-slate-200' : 'bg-slate-700 hover:bg-slate-600'}`}
              >
                إغلاق
              </button>
            </div>
