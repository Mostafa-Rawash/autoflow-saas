    ...
    <div className={`min-h-screen flex items-center justify-center p-4 ${theme === 'light' ? 'bg-slate-50' : 'bg-dark-950'}`}>
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className={`text-2xl font-bold mt-6 mb-2 ${theme === 'light' ? 'text-slate-900' : 'text-white'}`}>مرحباً بعودتك! 👋</h1>
          <p className={theme === 'light' ? 'text-slate-500' : 'text-slate-400'}>سجل دخولك للوصول للوحة التحكم</p>
        </div>
        ...
        <div className="card p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full border rounded-xl py-3 pr-10 pl-4 focus:border-primary-500 focus:ring-1 focus:ring-primary-500 outline-none transition ${theme === 'light' ? 'bg-white border-slate-300' : 'bg-dark-800 border-dark-600'}`}
                  required
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full border rounded-xl py-3 pr-10 pl-10 focus:border-primary-500 focus:ring-1 focus:ring-primary-500 outline-none transition ${theme === 'light' ? 'bg-white border-slate-300' : 'bg-dark-800 border-dark-600'}`}
                  placeholder="••••••••"
                  required
                />
                <button
            ...
            {/* Remember me */}
            <label className={`flex items-center gap-2 text-sm select-none ${theme === 'light' ? 'text-slate-600' : 'text-slate-300'}`}>
              <input
                type="checkbox"
                checked={rememberMe}
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className={`px-2 ${theme === 'light' ? 'bg-slate-50 text-slate-500' : 'bg-dark-950 text-slate-400'}`}>أو</span>
            </div>
          </div>

          {/* Register link */}
          <p className={`text-center ${theme === 'light' ? 'text-slate-500' : 'text-slate-400'}`}>
            ليس لديك حساب؟{' '}
