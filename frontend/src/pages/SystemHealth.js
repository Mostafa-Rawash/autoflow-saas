    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">مراقبة صحة وصلاحية الخدمات</p>
        </div>
        <button
          onClick={checkHealth}
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-500">آخر فحص: {new Date().toLocaleTimeString('ar-EG')}</p>
            </div>
          </div>
          <div className="text-right">
            <p className="text-slate-500 text-sm">وقت التشغيل</p>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div className="card p-5">
          ...
          {health.api.latency && (
            <p className="text-sm text-slate-500">زمن الاستجابة: {health.api.latency}ms</p>
          )}
        </div>
        ...
        <div className="card p-5">
          ...
          {health.database.size && (
            <p className="text-sm text-slate-500">الحجم: {health.database.size}</p>
          )}
        </div>
          ...
          {health.storage.used && (
            <div>
              <div className="flex justify-between text-sm mb-1">
                <span className="text-slate-500">{health.storage.used}% مستخدم</span>
                <span className="text-slate-500">{health.storage.total} GB</span>
              </div>
        ...
        <div className="card p-5">
          ...
          {health.memory.used && (
            <p className="text-sm text-slate-500">{health.memory.used}% مستخدم</p>
          )}
        </div>
        ...
        <div className="card p-5">
          ...
          <p className="text-sm text-slate-500">SSL فعال • HTTPS</p>
        </div>
      </div>
