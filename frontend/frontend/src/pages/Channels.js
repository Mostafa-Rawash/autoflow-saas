...
import { Check, X, RefreshCw, ExternalLink, Power, Settings, QrCode, Lock, Sparkles } from 'lucide-react';
...
const Channels = () => {
  ...
  // Channels data - WhatsApp is active, others are coming soon
  const [channels, setChannels] = useState([
    { id: 'whatsapp', name: 'واتس آب', icon: '📱', color: '#25D366', status: 'connected', lastSync: '2026-04-04T14:30:00Z', messages: 523, available: true },
    { id: 'messenger', name: 'ماسنجر', icon: '💬', color: '#0084FF', status: 'coming-soon', lastSync: null, messages: 0, available: false },
    { id: 'instagram', name: 'إنستجرام', icon: '📷', color: '#E4405F', status: 'coming-soon', lastSync: null, messages: 0, available: false },
    { id: 'telegram', name: 'تيليجرام', icon: '✈️', color: '#0088cc', status: 'coming-soon', lastSync: null, messages: 0, available: false },
    { id: 'livechat', name: 'Live Chat', icon: '🖥️', color: '#00D4AA', status: 'coming-soon', lastSync: null, messages: 0, available: false },
    { id: 'email', name: 'بريد إلكتروني', icon: '📧', color: '#EA4335', status: 'coming-soon', lastSync: null, messages: 0, available: false },
    { id: 'sms', name: 'SMS', icon: '📱', color: '#7C3AED', status: 'coming-soon', lastSync: null, messages: 0, available: false },
    { id: 'api', name: 'API', icon: '🔗', color: '#F59E0B', status: 'connected', lastSync: '2026-04-04T12:00:00Z', messages: 89, available: true }
  ]);
  ...
  const handleDisconnect = (channelId) => {
    setChannels(prev => prev.map(ch => 
      ch.id === channelId 
        ? { ...ch, status: 'disconnected', lastSync: null }
        : ch
    ));
